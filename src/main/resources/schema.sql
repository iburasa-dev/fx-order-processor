...
VALUES 
    ('EUR', 'USD', 1.161500, CURRENT_TIMESTAMP),
    ('GBP', 'USD', 1.349700, CURRENT_TIMESTAMP),
    ('JPY', 'USD', 0.006410, CURRENT_TIMESTAMP),
    ('CAD', 'USD', 0.725058, CURRENT_TIMESTAMP),
    ('AUD', 'USD', 0.719321, CURRENT_TIMESTAMP),
    ('CHF', 'USD', 1.236950, CURRENT_TIMESTAMP),
    ('USD', 'EUR', 0.860960, CURRENT_TIMESTAMP),
    ('USD', 'GBP', 0.740900, CURRENT_TIMESTAMP),
    ('USD', 'JPY', 156.010000, CURRENT_TIMESTAMP),
    ('USD', 'AED', 3.672500, CURRENT_TIMESTAMP),
    ('AED', 'USD', 0.272294, CURRENT_TIMESTAMP),
    ('EUR', 'AED', 4.265609, CURRENT_TIMESTAMP),
    ('AED', 'EUR', 0.234433, CURRENT_TIMESTAMP),
    ('GBP', 'AED', 4.956773, CURRENT_TIMESTAMP),
    ('AED', 'GBP', 0.201744, CURRENT_TIMESTAMP),
    ('USD', 'SAR', 3.750000, CURRENT_TIMESTAMP),
    ('SAR', 'USD', 0.266667, CURRENT_TIMESTAMP),
    ('USD', 'INR', 94.490000, CURRENT_TIMESTAMP),
    ('INR', 'USD', 0.010583, CURRENT_TIMESTAMP),
    ('USD', 'SGD', 1.267800, CURRENT_TIMESTAMP),
    ('SGD', 'USD', 0.788768, CURRENT_TIMESTAMP)
